            ...
            <CommentThread onPost={(commentText) => this.handleCommentPost(commentText)}>
              {
                data.comments.map((comment, i) => {
                  ...
                  return (
                    <Comment likeCounter={comment.likeCounter} feedItemId={this.state._id} index={(i)} key={i} author={comment.author} postDate={comment.postDate}>{comment.contents}</Comment>
                  );
                })
              }
            </CommentThread>
